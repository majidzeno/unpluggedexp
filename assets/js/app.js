...
var _foundationSites = __webpack_require__(11);
...
(0, _jquery2.default)(window).on('load', function () {
	...
	// .duration('200%')
	.setTween(firstSectionTimeline).addIndicators({ name: 'Wire Animation' }).addTo(firstSectionController);

	var secondSectionController = new ScrollMagic.Controller();
	var duration = 1;
	var devicesTimeline = new TimelineMax().from('#iMac', 1, { left: '-100%', ease: Back.easeOut }).from('#iMac_logo', 1, { left: '-100%', ease: Back.easeOut }, "-=1").from('#iPhone', 1, { left: '-100%', ease: Back.easeOut }).from('#iPad', 1, { left: '-100%', ease: Back.easeOut })
	// .to('#section2',1,{ rotation : '-20deg',ease :Linear.easeOut})
	.to('#iPad', 1, { left: '-100%', ease: Linear.ease })
	// .to('#iMac',1,{left : '-100%' ,ease : Linear.easeIn})
	.to('#iPhone', 1.5, { left: '200%', ease: Linear.ease }, '-=1').to('#iMac', 1, { top: '75%', width: '102%', height: '151%', ease: Linear.easeOut }, "-=1").to('#iMac_logo', 1, { top: '15%', left: '23%', ease: Expo.easeOut }, "-=.5").staggerTo('.unplugged__mission', 1, { display: 'block', ease: Expo.easeOut }, '.1');
	...
	// .setPin('#exp-cont')
	.setPin('#section2').setTween(devicesTimeline).addIndicators({ name: 'iMac Animation' }).addTo(secondSectionController);

	var thirdSectionController = new ScrollMagic.Controller();
	var egyptTimeline = new TimelineMax().staggerTo('.egypt', 3, { display: 'block', ease: Power0.easeOut }, '.3');
	...
	// .setPin('#exp-cont')
	.setPin('#section3').setTween(egyptTimeline).addIndicators({ name: 'egypt Animation' }).addTo(thirdSectionController);

	var section4Controller = new ScrollMagic.Controller();
	var recipeTimeline = new TimelineMax().from('#coffeeBag', .5, { top: '150%', ease: Expo.easeOut }).from('.coffeeBeans', .5, { top: '150%', ease: Expo.easeOut }, '-=.3').to('#designSave-wrapper', .5, { display: 'flex', ease: Expo.easeOut }).staggerTo('.designSave', .2, { display: 'block', ease: Expo.easeOut }, .1).to('#designSave-wrapper', .1, { display: 'none', ease: Expo.easeOut }).to('#folderName-wrapper,#folder', .1, { display: 'flex', ease: Expo.easeOut }).to('#folderName-wrapper', .1, { border: '1px solid', ease: Expo.easeOut }).staggerTo('.folderName', .2, { display: 'block', ease: Expo.easeOut }, .1).to('#folderName-wrapper', .1, { border: '0', ease: Expo.easeOut }).to('.coffee-wrapper', .5, { top: '-40%', left: '-43%', scale: '.1', ease: Expo.easeOut }, '+=.5').to('.coffee-wrapper', .1, { display: 'none', ease: Expo.easeOut }).to('#folderName-wrapper,#folder', .1, { display: 'none', ease: Expo.easeOut }).to('#html', .5, { display: 'flex', ease: Expo.easeOut }).staggerTo('.htmlCup', .2, { display: 'block', ease: Expo.easeOut }, .1).to('#html', .1, { display: 'none', ease: Expo.easeOut }).to('#htmlCup', .5, { display: 'block', ease: Expo.easeOut }).to('#htmlCup', .5, { left: '45%', ease: Expo.easeOut }).to('#htmlCup', .5, { left: '23%', ease: Expo.easeOut }).to('#cssCup', .5, { display: 'block', ease: Expo.easeOut }).to('#jsCup', .5, { display: 'block', ease: Expo.easeOut }).to('#wordpressCup', .5, { display: 'block', ease: Expo.easeOut }).to('#reactCup', .5, { display: 'block', ease: Expo.easeOut });
	...
	var scene = new ScrollMagic.Scene({
		...
		offset: '0',
		duration: '800%'
	}).setPin('#section4').setTween(recipeTimeline).addIndicators({ name: 'PS Animation' }).addTo(section4Controller);
});
